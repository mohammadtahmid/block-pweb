          ...
          <div class="container">
            ...
            <?php
              ...
              <div class="col-9 social">
                <a href="<?=$row['twtter']?>" target="_blank"><span class="fa fa-twitter"></span></a>
                <a href="<?=$row['facebook']?>" target="_blank"><span class="fa fa-facebook"></span></a>
                <a href="<?=$row['insta']?>" target="_blank"><span class="fa fa-instagram"></span></a>
                <a href="<?=$row['youtube']?>" target="_blank"><span class="fa fa-youtube-play"></span></a>
              </div>
                  <?php
                }
              }
